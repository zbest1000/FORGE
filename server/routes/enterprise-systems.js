...
export default async function enterpriseSystemRoutes(fastify) {
  ...
  fastify.post("/api/enterprise-systems", { preHandler: require_("integration.write") }, async (req, reply) => {
  ...
  fastify.patch("/api/enterprise-systems/:id", { preHandler: require_("integration.write") }, async (req, reply) => {
  ...
  fastify.post("/api/enterprise-systems/:id/sync", { preHandler: require_("integration.write") }, async (req, reply) => {
  ...
  fastify.post("/api/external-links", { preHandler: require_("integration.write") }, async (req, reply) => {
