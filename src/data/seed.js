...
export function buildSeed() {
  ...
  // Demo PDF: small (~3 KB) hand-rolled multi-page PDF generated by
  // `scripts/generate-demo-pdf.mjs` and bundled at the repo root.
  // Served as `/sample.pdf` in both dev (FORGE_SERVE_SOURCE=1) and
  // production (Vite copies via `copyRootStatics`). Local path avoids
  // the CSP `connect-src` restrictions and works offline.
  // Operators replace this with real documents via "Attach PDF".
