...
import { kanbanView } from "./workBoardKanban.js";
import { tableView } from "./workBoardTable.js";
...
// resolving the same names — the implementations now live in their
// dedicated view modules + workBoardItem.js / workBoardBatch.js.
export { calendarView, dependencyView, kanbanView, tableView, toggleBatch };
export { COLUMNS };
